...
export class InitialSchema1789242329624 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d37be6b22047f56ea87bea795b"`,
      undefined,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_460b1afc096014ca2dc5a5f5aa"`,
      undefined,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9b03a92219b0684dbd4403e624"`,
      undefined,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9148fe2c2fd83f5b59d391088c"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d689965b8c58ebf316fce60fab"`,
      undefined,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4fbe6303db2827370c0ec2d027"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_717e7792b8f31c319b6c7b8135"`,
      undefined,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8dbe001861ca34ae8b687e6bae"`,
      undefined,
    );
    await queryRunner.query(
      `DROP TABLE "product_option_channels_channel"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_86bc376c56af8cefd41a847a95"`,
      undefined,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bf45bd67c7b3278d7e1f2f9517"`,
      undefined,
    );
    await queryRunner.query(`DROP TABLE "api_key_translation"`, undefined);
    await queryRunner.query(
      `DROP INDEX "public"."settings_store_key_scope_unique"`,
      undefined,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8d8ddb95a0fbd11ffb5606ef0c"`,
      undefined,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ab560f7983976aec91b91c26a4"`,
      undefined,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_af13739f4962eab899bdff34be"`,
      undefined,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4eed4464adef51f53e1c7d8021"`,
      undefined,
    );
