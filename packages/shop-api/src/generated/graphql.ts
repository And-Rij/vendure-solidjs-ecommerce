...
export type AddItemToOrderMutation = { addItemToOrder:
    ...
    | { __typename: 'Order', id: string, code: string, totalQuantity: number, totalWithTax: number, currencyCode: CurrencyCode }
...
export type GetActiveOrderQuery = { activeOrder: { id: string, code: string, totalQuantity: number, totalWithTax: number, currencyCode: CurrencyCode } | null };
...
export type GetProductBySlugQuery = { product: { id: string, name: string, slug: string, description: string, variants: Array<{ id: string, name: string, sku: string, currencyCode: CurrencyCode, priceWithTax: number, stockLevel: string, options: Array<{ code: string, name: string, group: { code: string, name: string } }> }> } | null };
